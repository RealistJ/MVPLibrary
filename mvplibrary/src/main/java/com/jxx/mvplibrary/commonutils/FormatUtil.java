...
public class FormatUtil {
    ...
    /**
     * 将手机号转换成344格式的字符串 如: 133 3333 3333
     *
     * @param strPhone
     * @return
     */
    public static String formatPhoneNumberTo344(String strPhone) {
        String strTem = "";
        if (strPhone != null && strPhone.length() == 11) {
            strTem = strPhone.substring(0, 3) + " ";
            strTem = strTem + strPhone.substring(3, 7) + " ";
            strTem = strTem + strPhone.substring(7);
        }
        return strTem;
    }
}
